...
sys.path.insert(1, '/Users/v_tatarnikov/ownCloud/Projects/_pycharm/Scopuli/scopuli-docs')
sys.path.insert(1, '/Users/v_tatarnikov/ownCloud/Projects/_pycharm/Scopuli/scopuli-core')
sys.path.insert(2, '/Users/v_tatarnikov/ownCloud/Projects/_pycharm/Scopuli/scopuli-core-config')
sys.path.insert(3, '/Users/v_tatarnikov/ownCloud/Projects/_pycharm/Scopuli/scopuli-core-console')
sys.path.insert(4, '/Users/v_tatarnikov/ownCloud/Projects/_pycharm/Scopuli/scopuli-core-gui')
...
project = u'Scopuli'
copyright = u'2018, Viktor Tatarnikov'
...
latex_documents = [
    (master_doc, 'forGain.tex', u'forGain Documentation',
...
def autodoc_skip_member(app, what, name, obj, skip, options):
    from AutoDoc.Schema import Schema as AutoDocSchema
...
def autodoc_render_schema():
    from AutoDoc.SchemaDisplay import SchemaDisplay as AutoDocSchemaDisplay
